...
class TestSchemaUsage(unittest.TestCase):
    ...
    def test_schema_is_valid_json(self):
        self.schema = self.test_gen.generate_schema(
            "create a list of integers max length 5")
        ...
        try:
            self.assertTrue(self.schema.validate_schema(),
        ...
        self.assertEqual(
            response, expected,
            "The generated list does not match the expected list.")
